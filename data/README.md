...
Note that there may be discrepancies between the sentences included in the OSF repository made availble by the authors of Pereirs et al. and those reported in `screen_sentences.csv`. We ensured that the sentences from `screen_sentences.csv` were exactly those seen by participants.
